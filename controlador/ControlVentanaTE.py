...
class ControlVentanaTE(QtWidgets.QMainWindow, Ui_MainWindowTE):
    ...
    def practicas_en_progreso(self):
        ...
        self.ventana_progreso = ControlVentanaTEPracticaEnProgreso(self.usuario, self, self.login)
    ...
    def practicas_completas(self):
        ...
        self.ventana_completas = ControlVentanaTEPracticasCompletadas(self.usuario, self, self.login)
