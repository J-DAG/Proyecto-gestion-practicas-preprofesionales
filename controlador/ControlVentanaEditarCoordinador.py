...
class ControlVentanaEditarCoordinador(QtWidgets.QWidget):
    def __init__(self, usuario: Coordinador, parent=None):
        super().__init__()
        self.usuario = usuario
        self.parent_controller = parent
        self.setWindowTitle("Editar coordinador")
    ...
    def guardar(self):
        try:
            ...
            QtWidgets.QMessageBox.information(self, "Coordinador actualizado", "Cambios guardados correctamente.")
